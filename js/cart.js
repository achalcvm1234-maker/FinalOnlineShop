                ...
                <div style="display:flex; align-items:center; gap:10px;">
                    ...
                    <div>
                        ...
                        <div style="display:flex; align-items:center; gap:8px; margin-top:6px;">
                            <button type="button" data-action="cart-qty" data-idx="${idx}" data-change="-1" style="width:28px; height:28px; background:var(--blush); border:1px solid var(--blush-deep); border-radius:4px; cursor:pointer; font-weight:bold; touch-action:manipulation;">-</button>
